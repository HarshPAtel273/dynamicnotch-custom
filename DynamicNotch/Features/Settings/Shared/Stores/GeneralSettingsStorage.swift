enum GeneralSettingsStorage {
    ...
    static let defaultValues: [String: Any] = [
        ...
        Keys.notchExpandInteraction: NotchExpandInteraction.click.rawValue,
        ...
        Keys.volumeFeedbackSoundEnabled: false,
        ...
        Keys.homePageOrder: ["camera", "appleMusic", "todos", "fileTray", "aiUsage", "localTimer", "systemStats"],
